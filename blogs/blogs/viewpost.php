        ...
        <?php include 'includes/topbar.php';?>
                        ...
                        <div class="swiper-container swipe1">
                            ...
                            <div class="swiper-slide">
                              <a href="viewpost.php?vid=<?= $result['id'];?>"><img src="<?= $explode[1];?>" class="img-fluid card-img-top" alt="sliding image"></a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="list-group" style="margin:40px 0 10px 0;">
                            ...
                            <a href="latest.php" class="list-group-item">Latest </a>
                            <a href="popular.php" class="list-group-item primary">Popular</a>
							<a href="politics.php" class="list-group-item">politics </a>
